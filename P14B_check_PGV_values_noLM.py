"""
Plots PGV information of events NOT from the lunar module (LM)
"""
import pandas as pd
import numpy as np
...
def main():
    ...
    ax0.set_title('PGV Values No LM', fontweight='bold')
    ...
    fig.tight_layout()
    fig.savefig(f'{pgv_results_dir}pgv_cumulative_vals_noLM.png')
    fig.savefig(f'{pgv_results_dir}pgv_cumulative_vals_noLM.eps')
    return
